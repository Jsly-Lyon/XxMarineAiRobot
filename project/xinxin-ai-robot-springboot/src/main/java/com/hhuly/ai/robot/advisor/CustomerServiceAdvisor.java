 ...
 * @Date: 2026/9/5 13:40
 * @Version: v1.0.0
 * @Description: 智能客服 Advisor（双路检索增强：Dense + BM25 -> RRF）
 **/
@Slf4j
public class CustomerServiceAdvisor implements StreamAdvisor {

    private final CustomerKnowledgeSearchService searchService;
    ...
    public CustomerServiceAdvisor(CustomerKnowledgeSearchService searchService) {
